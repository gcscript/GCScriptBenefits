...
public static class Settings
{
    ...
    public static readonly string TxtOrderFilePath = Path.Combine(DesktopPath, "___ped.txt");
    public static readonly string XmlOrderFilePath = Path.Combine(DesktopPath, "___ped.xml");
    public static readonly string TxtRegisterFilePath = Path.Combine(DesktopPath, "___cad.txt");
